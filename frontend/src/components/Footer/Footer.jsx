      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-amber-200/90 text-sm font-sacramento italic">
              {/* Get all the freshness — no colors, no artificial flavors. */}
              {t("get_all_the_freshness_no colors...")}
              <br />
        ...
        <div className="border-t border-amber-800 pt-8 mt-8 text-center">
          <p className="text-amber-400 text-lg mb-2 font-playfair">
            © Smoothie Season - Baxtyari.
          </p>
          <div className="group inline-block">
            <a
              // href="https://hexagondigitalservices.com"
              href="https://glossycode.com/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              {/* Created by GlossyCode. All rights reserved. */}
              {t("created_by_glossyCode")}
            </a>
          </div>
        </div>
      </div>
